        ...
        <div class="row" style="margin-top:15px;">
            ...
            <div class="col-md-9">
                <div style="background-color: #fff;border: 1px solid #e6e6e6;border-top:2px solid #0074AA;padding: 20px 13px 13px 13px;">
                    ...
                    <div class="detail">
                        <h3 class="detail_title">${notice.title }</h3>
                        <p class="detail_time"> 
                        	来源：<span>${notice.user.trueName }</span>
                			发布时间：<span><fmt:formatDate value='${notice.createTime }' pattern='YYYY-MM-dd'/></span>
                			人气：<span>${notice.viewedNum }</span>
                      	</p>
