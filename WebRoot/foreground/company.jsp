...
<body onload="javascript:initialize();">
            ...
            <div class="col-md-9">
                <div style="background-color: #fff;border: 1px solid #e6e6e6;border-top:2px solid #0074AA;padding: 20px 13px 13px 13px;">
                    <div class="select_title">
                        <h4 style="padding-bottom: 10px;"><a>企业搜索</a></h4>
                        <div class="recruit_select">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <input id="name" placeholder="请输入企业名称" type="text" size="43" value="" />
	...
	<script type="text/javascript">
		function search(){
			...
			page("${pageContext.request.contextPath}/user/index.do?"+param);
		}
		...
		function page(url){
			$.post(url,{},
					function(result){
						...
						var list="";
						var date = new Date();
						$.each(result.companyList,function(i,company){
			                list+=       
								"<tr>"+
			                        "<td><a style='width: 180px' href='${pageContext.request.contextPath}/user/detail.do?userId="+company.id+"'>"+company.trueName+"</a></td>"+
			                        "<td>"+company.nature+"</td>"+
			                        "<td>"+company.scale+"</td>"+
			                        "<td>"+company.province+"/"+company.city+"</td>"+
			                        "<td>"+company.careerTwo.name+"</td>"+
			                    "</tr>";
						});
						$(".list").append(list);
		...
		$(function(){
			page("${pageContext.request.contextPath}/user/index.do");
		})
	</script>
</body>
</html>