...
<body>
                        ...
                        <ul class="list">
                        	<%--<c:forEach items="${dynamicList }" var="dynamic">
	                            <li>
	                                ...
	                                <span><fmt:formatDate value='${dynamic.time }' pattern='YYYY-MM-dd'/></span>
	                            </li>
                        	</c:forEach>--%>
                        </ul>
                    </div>
	...
	<script type="text/javascript">
		function page(url){
			$.post(url,{},
					function(result){
						...
						var list="";
						var date = new Date();
						$.each(result.dynamicList,function(i,dynamic){
							date.setTime(dynamic.time.time);
			                list+=       
				                "<li>"+
			                        "<a href='${pageContext.request.contextPath}/dynamic/detail.do?id="+dynamic.id+"'>"+dynamic.title+"</a>"+
		...
		$(function(){
			page("${pageContext.request.contextPath}/dynamic/index.do");
		});
	</script>
</body>
</html>