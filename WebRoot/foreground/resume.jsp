...
<body onload="javascript:initialize();">
    ...
    <div class="m_tab">
        <div class="container">
            ...
            <a class="active" href="${pageContext.request.contextPath}/foreground/resume.jsp">求职信息</a>
            ...
            <div class="col-md-9">
                <div style="background-color: #fff;border: 1px solid #e6e6e6;border-top:2px solid #0074AA;padding: 20px 13px 13px 13px;">
                    <div class="select_title">
                        <h4 style="padding-bottom: 10px;"><a>简历搜索</a></h4>
                        <div class="recruit_select">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p class="left" style="margin-left: 28px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;更新时间：&nbsp;&nbsp;</p>
                                ...
                                <li>
                                    ...
                                    <input id="name" placeholder="请输入简历名称" type="text" size="43" value="" />
	...
	<script type="text/javascript">
		function search(){
			...
			page("${pageContext.request.contextPath}/resume/index.do?"+param);
		}
		...
		function page(url){
			$.post(url,{},
					function(result){
						...
						var list="";
						var date = new Date();
						$.each(result.resumeList,function(i,resume){
							date.setTime(resume.refreshDate.time);
			                list+=       
								"<tr>"+
			                        "<td><a href='${pageContext.request.contextPath}/resume/detail.do?id="+resume.id+"' target=_blank>"+resume.resumeName+"</a></td>"+
			                        "<td>"+resume.user.trueName+"</td>"+
	                        		"<td>"+resume.careerThree.name+"</td>"+
	                        		"<td>"+resume.salary+"</td>"+
	                        		"<td>"+resume.user.major.name+"</td>"+
		...
		$(function(){
			...
			page("${pageContext.request.contextPath}/resume/index.do");
		})
	</script>
</body>
</html>