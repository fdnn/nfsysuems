            ...
            <div class="col-md-3">
            	<div style="background-color: #fff;border: 1px solid #e6e6e6;border-top:2px solid #0074AA;padding: 20px 13px 13px 13px;">
					...
					<div class="container_nav">
					    <ul>
					        <h4>我的简历</h4>
					        <a href="${pageContext.request.contextPath}/resume/save.do"><li class="nav_active"><p>创建简历</p></li></a>
                ...
                <div style="background-color: #fff;border: 1px solid #e6e6e6;border-top:2px solid #0074AA;padding: 20px 13px 13px 13px;">
                	<div>
						<div class="container_main">
					        ...
					        <h4 class="left" id="resumeName"></h4>
					        <input hidden type="text" id="jlmc" name="resumeName"  onblur="updateResumeName()" value="" />
					        <input hidden id="idsingle" name="id" value="${resume_id }" />&nbsp;&nbsp;
						       	...
						       	<div class="xinxi">
							       	...
							       	<div class="pic" style="float:right;margin-right:60px;">
							       		<c:choose>
					                       	...
					                       	<c:otherwise>
					                            <img src="${pageContext.request.contextPath}/images/touxiang.jpg" width="100px;">
					                       	</c:otherwise>
					                    </c:choose>
							       	</div>
						       	</div>
					    ...
					    <div class="resume_02">
					        ...
					        <div class="neirong">
						        ...
						        <table class="content qzyx_save" width="100%" style="display: block;">
						            <form id="qzyx_fm">
							            <tbody>
							            	<input name="id" hidden value="${resume_id }"/>
								            <tr>
						        ...
						        <table class="content jybj_save" width="100%" style="display: none;">
						            <form id="jybj_fm">
							            <tbody>
								            ...
								            <input name="resume.id" hidden value="${resume_id }"/>
								            <tr>
								                <th width="20%"><span style="color:red">*</span>起止时间：</th>
								                <td width="50%" colspan="2">
								                	<input name="start" id="jybj_start" class="Wdate" style="height:27px;width:100px;float:left;" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                	<span style="float:left" >-</span><input name="end" id="jybj_end" class="Wdate" style="height:27px;width:100px;float:left;" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                </td>
								            </tr>
								            <tr>
						            ...
						            <form id="gsjy_fm">
							            <tbody>
								            ...
								            <tr>
								                ...
								                <td width="40%">
								                	<input name="start" id="gsjy_start" class="Wdate" style="height:27px;width:100px;float:left;" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                	<span style="float:left" >-</span>
								                	<input name="end" id="gsjy_end" class="Wdate" style="height:27px;width:100px;float:left;" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                </td>
								                <th></th>
								                <td></td>
								            </tr>
								            ...
								            <tr>
								                <th>工作/实习描述：</th>
								                <td colspan="3">
								                	<textarea name="jobDescription" cols="87" rows="4" id="gsjy_jobDescription" maxlength="1000"></textarea>
						            ...
						            <form id="xmjy_fm">
							            <tbody>
								            ...
								            <tr>
								                <th width="20%"><span style="color:red">*</span>起止时间：</th>
								                <td width="40%">
								                	<input name="start" id="xmjy_start" class="Wdate" style="height:27px;width:100px;float:left;" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                	<span style="float:left" >-</span>
								                	<input name="end" id="xmjy_end" class="Wdate" style="height:27px;width:100px;float:left;" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                </td>
								                <th></th>
								                <td></td>
								            </tr>
								            ...
								            <tr>
								                <th>详细描述：</th>
								                <td><textarea name="description" id="xmjy_description" onblur="" rows="5" cols="70"></textarea></td>
								            </tr>
								            <tr>
								                <td></td>
								                <td>
							        ...
							        <form id="zs_fm">
							            <tbody>
								            ...
								            <tr>
								                ...
								                <td width="30%">
								                	<input name="time" id="zs_time" class="Wdate" style="height:27px;width:200px" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:false})" />
								                </td>
								                <td></td>
								                <td></td>
								            </tr>
						        ...
						        <table class="content zwpj_save" width="100%" style="display: block;">
						        	<form id="zwpj_fm">
							            <tbody>
								            ...
								            <tr>
								                <td>
								                    <textarea name="evaluation" id="zwpj_evaluation" cols="87" rows="5" maxlength="1000"></textarea>
								                </td>
								            </tr>
								            <tr>
								                <td>
