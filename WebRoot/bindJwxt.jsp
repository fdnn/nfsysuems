...
<script type="text/javascript">
	function checkForm() {
		...
		if(txtSecretCode == null || txtSecretCode == ""){
			alert("验证码不能为空！");
			return false;
		}
		return true;
    ...
    <div class="container login_main" style="position: absolute;z-index: 10;width: 100%;">
    	<div class="container">
			<form id="login" method="post" onsubmit="return checkForm()"
				name="login" action="${pageContext.request.contextPath}/user/bindJwxt.do">
				<!-- 登录窗口 -->
				<div class="right login_form">
					<div class="identity_main">
						<ul>
							<a href="javascript:void()">
								<li style="width:100%" class="removeClass selected">学生教务系统账号绑定</li>
							</a>
						</ul>
					...
					<div class="submit_input">
						<ul>
							<li>
								<input name="userName" placeholder="请输入教务系统账号" type="text" size="32" maxlength="40" id="userName" />
							</li>
							<li>
								<input name="password" placeholder="请输入教务系统密码" type="password" size="32" id="password" />
							</li>
							<li class="secretCode">
							...
							<li>
								<input type="submit" name="submit" value="立即绑定" id="submit" />
							</li>
